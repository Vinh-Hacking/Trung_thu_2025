...
function preload() {
  ...
  let allLanternPaths = [
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_1-removebg-preview.png",
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_2-removebg-preview.png",
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_3-removebg-preview.png",
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_4-removebg-preview.png",
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_5-removebg-preview.png",
    "../LongDen_1/AnhLongDenBay/Lồng_đèn_6-removebg-preview.png",
  ];
...
function setup() {
  ...
  canvas.style("top", "0");
  canvas.style("left", "0");
  canvas.style("z-index", "2"); // Set lower than fireworks z-index 10
  noStroke();
